...
import redo.tribaxy.com.utils.ViewUtils;

/**
 * Created by dalafiari on 11/19/17.
 */

public class PresetRadioCircleGroup extends LinearLayout {
    ...
    public PresetRadioCircleGroup(Context context) {
        super(context);
        setupView();
    }

    public PresetRadioCircleGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public PresetRadioCircleGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public PresetRadioCircleGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs,
                R.styleable.PresetRadioCircleGroup, 0, 0);
        try {
            mCheckedId = a.getResourceId(R.styleable.PresetRadioCircleGroup_presetRadioCheckedId, View.NO_ID);
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == PresetRadioCircleGroup.this && child instanceof RadioCheckable) {
                int id = child.getId();
